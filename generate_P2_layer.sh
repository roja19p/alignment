...
bash $HOME_alignment/get_parent_sanwawi.sh Eng Hnd   
...
python3 $HOME_alignment/src/get_anch_and_pot_info.py slot_debug_input_mapped.txt word.dat  manual_id_mapped.dat  > anchor.dat
...
python3 $HOME_alignment/src/prepare_e_sent_and_k_layer_info.py original_word.dat  id_Apertium_output.dat > info.tsv
