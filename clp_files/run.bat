...
(save-facts "anchor.dat" local iter-type-eng_g_id-h_g_id hindi_head_id-grp_ids iter-h_g_id no_match_found)
(clear)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(load "alignment_path.clp")
...
(agenda)
(run)
(save-facts "anchor5.dat" local iter-type-eng_g_id-h_g_id hindi_head_id-grp_ids iter-h_g_id no_match_found)
(clear)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(load "alignment_path.clp")
...
(agenda)
(run)
(save-facts "anchor6.dat" local iter-type-eng_g_id-h_g_id hindi_head_id-grp_ids iter-h_g_id no_match_found)
